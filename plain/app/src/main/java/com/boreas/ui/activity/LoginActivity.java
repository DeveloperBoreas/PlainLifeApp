...
import com.boreas.di.componects.DaggerLoginComponent;
import com.boreas.di.modules.LoginModule;
import com.boreas.presenter.LoginPresenter;
 ...
 * @author boreas
 */
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor>, PresenterContract.LoginView {
    ...
    private void initView() {
        ...
        binding.email.setOnClickListener(view -> attemptLogin());
        //presenter.initContentBg();
    }

    @Override
    public void setContentBg(int resId) {
        binding.loginContent.setBackgroundResource(resId);
    }
