...
public class KeeperCompletedChildAdapter extends BaseRecyclerAdapter<String> {

    public KeeperCompletedChildAdapter(Context context, List<String> list, int itemLayoutId) {
