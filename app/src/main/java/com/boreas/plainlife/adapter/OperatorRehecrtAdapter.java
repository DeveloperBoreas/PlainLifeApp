...
public class OperatorRehecrtAdapter extends BaseRecyclerAdapter<OperatorApplicationModel.DataBean.RehecrtBean> {

    public OperatorRehecrtAdapter(Context context, List<OperatorApplicationModel.DataBean.RehecrtBean> list, int itemLayoutId) {
        super(context, list, itemLayoutId);
    }

    @Override
    public void convert(BaseRecyclerHolder holder, OperatorApplicationModel.DataBean.RehecrtBean item, int position, boolean isScrolling) {
