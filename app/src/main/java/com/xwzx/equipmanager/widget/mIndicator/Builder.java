...
public class Builder {
     ...
     * @return Builder
     */
    public Builder showTimeTickTexts(boolean showTimeTickText) {
        this.showTimeTickText = showTimeTickText;
        return this;
    }
    ...
    public Builder tickTimeTextsArray(String[] tickTextsArray) {
        this.tickTimeTextsCustomArray = tickTextsArray;
        return this;
    }
    ...
    public Builder tickTimeTextsArray(@ArrayRes int tickTextsArray) {
        this.tickTimeTextsCustomArray = context.getResources().getStringArray(tickTextsArray);
        return this;
    }
