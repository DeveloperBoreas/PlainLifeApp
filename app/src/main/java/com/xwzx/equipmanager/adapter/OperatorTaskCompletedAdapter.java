...
public class OperatorTaskCompletedAdapter extends BaseRecyclerAdapter<TaskModel.DataBeanX.DataBean.TasksBean> {

    public OperatorTaskCompletedAdapter(Context context, List<TaskModel.DataBeanX.DataBean.TasksBean> list, int itemLayoutId) {
