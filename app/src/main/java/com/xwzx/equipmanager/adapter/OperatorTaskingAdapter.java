...
public class OperatorTaskingAdapter extends BaseRecyclerAdapter<TaskModel.DataBeanX.DataBean.TasksBean> {

    public OperatorTaskingAdapter(Context context, List<TaskModel.DataBeanX.DataBean.TasksBean> list, int itemLayoutId) {
