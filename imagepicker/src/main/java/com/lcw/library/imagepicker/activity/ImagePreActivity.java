...
public class ImagePreActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mIvPlay = (ImageView) findViewById(R.id.iv_main_play);
        mViewPager = (HackyViewPager) findViewById(R.id.vp_main_preImage);
        mLlPreSelect = (LinearLayout) findViewById(R.id.ll_pre_select);
        mIvPreCheck = (ImageView) findViewById(R.id.iv_item_check);
    }
